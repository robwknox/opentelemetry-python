...
class Span(object):
    ...
    def __init__(self, trace_id=None, name=None, id=None, parent_id=None, annotations=None, binary_annotations=None, debug=False, timestamp=None, duration=None, trace_id_high=None,):
...
Annotation.thrift_spec = (
    ...
    (3, TType.STRUCT, 'host', [Endpoint, None], None, ),  # 3
)
all_structs.append(BinaryAnnotation)
BinaryAnnotation.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'key', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'value', 'BINARY', None, ),  # 2
    (3, TType.I32, 'annotation_type', None, None, ),  # 3
    (4, TType.STRUCT, 'host', [Endpoint, None], None, ),  # 4
)
...
Span.thrift_spec = (
    ...
    (6, TType.LIST, 'annotations', (TType.STRUCT, [Annotation, None], False), None, ),  # 6
    None,  # 7
    (8, TType.LIST, 'binary_annotations', (TType.STRUCT, [BinaryAnnotation, None], False), None, ),  # 8
